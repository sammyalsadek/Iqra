...
export const icons = {
  ...
  minus: svg('<circle cx="12" cy="12" r="10"/><line x1="8" y1="12" x2="16" y2="12"/>'),
  ...
  bug: svg('<path d="M8 2l1.88 1.88M14.12 3.88L16 2M9 7.13v-1a3 3 0 0 1 6 0v1M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3c0 3.3-2.7 6-6 6M12 20v-9M6.53 9C4.6 8.8 3 7.1 3 5M6 13H2M6 17l-4 1M17.47 9c1.93-.2 3.53-1.9 3.53-4M18 13h4M18 17l4 1"/>'),
  ...
  flip: svg('<path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/>'),
};

export const logo = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none">
  <path d="M24 10 C24 10 13 11 9 14 L9 36 C13 33 24 32 24 32 C24 32 35 33 39 36 L39 14 C35 11 24 10 24 10Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>
  <text x="24" y="27" text-anchor="middle" font-family="'Amiri','Traditional Arabic',serif" font-size="12" fill="currentColor">إقرأ</text>
</svg>`;
